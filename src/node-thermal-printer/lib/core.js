...
class ThermalPrinter {
  ...
  tableCustom(data) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      //console.log("obj.text:",obj.text,'obj.width:',obj.width,'this.config.width:',this.config.width,'obj.cols:',obj.cols,'obj.text.length:',obj.text.length);
      if (obj.width) {
